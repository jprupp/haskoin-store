...
- Allow disabling web server to sync block chain only.
...
- Support latest version of haskoin-node.

## [1.6.0] - 2026-08-12

### Fixed

- Support for Bitcoin Cash 256-bit scripts.
- Address parsing now allows only correct lengths.
